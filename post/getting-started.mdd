...
math = true
summary = """
My new website is online. I used Hugo in combination with its amazing academic template. Find below some instructions to use it yourself!
"""
...
I've just uploaded my new website so that you can have easy access to my publications and further resources derived from my research.

To do so, I used the Academic framework, which enables you to easily create a beautifully simple personal or academic website using the [Hugo](https://gohugo.io) static site generator. Find below some details about how to implement your own site using this amazing tool.
